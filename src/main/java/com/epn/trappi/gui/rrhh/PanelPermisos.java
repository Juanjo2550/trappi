...
Connection connection = Objects.requireNonNull(DataBaseConnection.getInstance()).getConnection();
    ...
    private void initComponents() {
        ...
        PanelAspirante.add(jBtnBuscarAspirantes, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 390, -1, -1));
        ...
        cmbBuscarNombre.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                cmbBuscarNombreItemStateChanged(evt);
            }
        });
        cmbBuscarNombre.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbBuscarNombreActionPerformed(evt);
            }
        });
    ...
    private void cmbBuscarNombreItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbBuscarNombreItemStateChanged
        if(evt.getStateChange()==ItemEvent.SELECTED){
    ...
    }//GEN-LAST:event_cmbBuscarNombreItemStateChanged

    private void cmbBuscarNombreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbBuscarNombreActionPerformed
        // TODO add your handling code here:
