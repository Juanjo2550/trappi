 ...
 * @author stali
 */
public class DetalleEmpleadoGUI2 extends javax.swing.JFrame {
    private Empleado empleado;
  
    private PANTALLA_PRINCIPAL parentForm;
    /**
     * Creates new form Ejemplo_GUI
     */
    public DetalleEmpleadoGUI2() {
        initComponents();
    }
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetalleEmpleadoGUI2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetalleEmpleadoGUI2().setVisible(true);
            }
        });
    }
