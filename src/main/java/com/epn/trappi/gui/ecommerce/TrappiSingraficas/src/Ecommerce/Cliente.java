...
public class Cliente {
    ...
    String Correo="c";
    String Fechadenacimiento="23/10/1999";
    String Celular="095869493030";
    String Direccion="quito";
    String Cedula="0938492200";
    String Contraseña="c";
    
    public boolean entrarAlSistema(String usuario, String contrasena){
        boolean aux=false;
        if(usuario.equals(Main.cliente.Correo) && contrasena.equals(Main.cliente.Contraseña)){
            aux=true;
